        ...
        <div className="reveal" ref={deckDivRef}>
            <div className="slides">
                    ...
                    <div>
                        ...
                        <small>
                            <p className="fragment">
                                Ключевая идея: Имеется «внутреннее состояние» [a(t)], которое обновляется по мере обработки последовательности.
                            </p>
                        </small>
                    </div>
                </section>
                <section>
                    ...
                    <div>
                        ...
                        <div className="r-fit-text">
                            ...
                            <p>
                                {String.raw`$$ a^{<t>} = g_1(W_{aa}a^{t-1} + W_{ax}x^{<t>} + b_a)$$`}
                            </p>
                            <p>
                                {String.raw`$$ y^{<t>} = g_2(W_{ya}a^{<t>} + b_y)$$`}
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <section>
                        <div className="r-fit-text">
                            А теперь посмотрим, как можно посоединять
                        </div>
                    </section>
                    <section>
                    ...
                    <section>
                        <div>
                            ...
                            <div className='fragment horizontal-align fade-in'>
                                <img src={Smugjak} />
                                <div className="r-fit-text">
                                    Named Entity Recognition (NER) — это задача в области обработки естественного языка (NLP), направленная на выделение и классификацию именованных сущностей в тексте, таких как имена людей, названия организаций, даты, местоположения, суммы денег и другие типы специфических объектов.
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li className="fragment highlight-green ">Размер модели не увеличивается от длины входа</li>
                        <li className="fragment highlight-green ">Вычисления используют ранее полученную информацию (можно экономить)</li>
                        ...
                        <li className="fragment highlight-red ">Трудно получить результаты из далекого прошлого</li>
                        <li className="fragment highlight-red ">Нельзя предсказать будущее для текущего состояния</li>
                    </ul>
                </section>
            </div>
        </div >
