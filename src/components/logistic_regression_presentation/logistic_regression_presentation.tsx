            ...
            <div className="slides">
                ...
                <section>
                    <section>
                        ...
                        <p className="left-side-text">
                            <span>
                                {String.raw`$Y = \{0, 1, 2, \dots , n\}$ - задача классификации`}
                            </span>
                            <span>
                                {String.raw`$Y = \mathbb{R^n}$ - задача регрессии`}
                            </span>
                        </p>
                    </section>
                    <section>
                ...
                <section>
                    <div>
                        ...
                        <p>
                            {String.raw` $$y = f(x) = P(y | x)$$`}
                        </p>
                    </div>
                    <div>
                        Тогда "хорошей" функцией потерь будет функция правдоподобия
                        <p>
                            {String.raw`$$F(X, Y, f) = \prod_{i=1}^N P(y = y_i | x_i) $$`}
                        </p>
                    </div>
                </section>
                <section>
...
\end{pmatrix}
                        ...
                        <div>
                            {String.raw`$$LogReg = Softmax(Logits(x))$$`}
                        </div>
                    </section>
                    <section>
